...
//       <h1>Machine Ausfall Überprüfung</h1>
//         <p> Guten Tag! In diesem App  können Sie die potentielle Ausfallsituation Ihrer Maschine vorhersagen. 
...
//       <p class='footer'>&copy; 2024 Solaiman Karroumi. Alle Rechte vorbehalten.</p>
//       </footer>
//     </div>
//   );
// }
...
//     // Simuliere eine Verzögerung von 500ms, um eine glattere Benutzererfahrung zu gewährleisten
//     setTimeout(() => {
//       setIsLoggedIn(true);
//       setIsLoading(false); // Setze den Ladezustand auf false
//       // Speichere den Login-Status im local storage
...
//   const handleLogout = () => {
//     setIsLoggedIn(false);
//     // Lösche den Login-Status aus dem local storage
...
//     <div className="app">
//       {isLoading ? (
//         <p>Lade...</p> // Ladeanzeige anzeigen, während der Benutzer eingeloggt wird
//       ) : (
//         <>
//           {!isLoggedIn ? (
//             <header className="header">
//               <div className='login'>
//                 <h1 className='title'>Machine Ausfall</h1>
...
//             </header>
//           ) : (
//             <FeedbackDashboard onLogout={handleLogout} /> // Feedback-Dashboard anzeigen, wenn eingeloggt
//           )}
